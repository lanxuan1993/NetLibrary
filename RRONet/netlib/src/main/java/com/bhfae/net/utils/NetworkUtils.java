...
public class NetworkUtils {
    ...
    public static Boolean isInternetError(String string) {
        try {
            int i = Integer.parseInt(string);
            if (i == HttpConstant.NET_ERROR_CODE || i == HttpConstant.NET_ERROR_CODE
                    || i == HttpConstant.DATA_ERROR_CODE) {
                return true;
            } else {
                return false;
            }
